...
TERM_LOOKUP = {
    ...
    'method_type_non_uri': {
        'rab drilling': 'Corer:Drill',
        'auger': 'Hand:Auger',
        'borehole DST test': 'Other',
        'borehole fluid sampling': 'Hand',
        'borehole logging tool': 'Other',
        'bottle incubation': 'Other',
        'bottle incubation dark': 'Other',
        'bottle incubation light': 'Other',
        'chamber incubation': 'Other',
        'chamber incubation dark': 'Other',
        'chamber incubation light': 'Other',
        'core Kasten': 'Corer:Kastenlot',
        'core Mackereth': 'Corer',
        'core air': 'Corer',
        'core box': 'Corer:Box',
        'core catcher': 'Corer',
        'core conventional': 'Corer:Drill',
        'core cutter': 'Corer',
        'core diamond': 'Corer:Rock',
        'core drilling, unspecified': 'Corer:Drill',
        'core geoprobe': 'Corer',
        'core gravity': 'Corer:Gravity',
        'core incubation dark': 'Corer',
        'core incubation light': 'Corer',
        'core piston': 'Corer:Piston',
        'core push': 'Corer',
        'core sonic': 'Corer',
        'core spike': 'Corer',
        'core vibro': 'Corer:Vibrating',
        'current meter': 'Other',
        'dredge': 'Dredge',
        'dredge benthic': 'Dredge',
        'dredge chain bag': 'Dredge:Chainbag',
        'dredge diamantina': 'Dredge',
        'dredge pipe': 'Dredge',
        'drilling': 'Corer:Drill',
        'field mapping survey': 'Other',
        'grab': 'Grab',
        'grab Eckman': 'Grab',
        'grab ROV': 'Grab',
        'grab Shipek': 'Grab',
        ...
        'outcrop sampling': 'Hand',
        'percussion drilling': 'Corer:Drill',
        'pit or trench sampling': 'Hand',
        'rotary drilling': 'Corer:Drill',
        'sidewall core, bullet': 'Other',
        'sidewall core, mechanical': 'Other',
        'sonde': 'Other',
        'surface material sampling': 'Hand',
        'undergound mine sampling': 'Hand',
        'underwater camera': 'Other',
        'unknown': 'Unknown',
        'water sampling': 'Hand'
    },
    'material_type': {
